...
public class MyShiroRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		/* 
	       ...
	       UserInfo userInfo  = (UserInfo)principals.getPrimaryPrincipal();  //当前MyShiroRealm类中获取用户信息的时候没能获取到用户角色以及权限相关信息，需要手动在身份认证里面将获取到的信息放入UserInfo实体中(doGetAuthenticationInfo中的UserInfo中)
